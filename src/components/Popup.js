...
export default function Popup({closePopup,currentDish,allDishes,addToCartHandler}) {
...
return menuItem.strMeal==currentDish
 ...
 <button onClick={()=>addToCartHandler(item.strMealThumb,item.strMeal)}>Checkout</button>
